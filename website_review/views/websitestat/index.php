...
<div class="row-fluid">
    ...
    <div class="span9">
        <div class="row-fluid">
            <div class="span6">
                <img class="thumbnail" id="thumb_<?php echo $website['id'] ?>" src="<?php echo Yii::app() -> getBaseUrl(true) ?>/img/loader.gif" alt="<?php echo $website['domain'] ?>" />
            </div>
            <div class="span6">
                <h1 class="h-review"><?php echo Yii::t("app", "Analyse of {Domain}", array("{Domain}" => $website['domain'])) ?></h1>
        ...
        <div class="row-fluid">
            ...
            <table class="table table-striped table-fluid">
                ...
                <tr>
                    ...
                    <td width="70%">
                        <?php echo Yii::t("app", "Domain") ?> : <?php echo $website['domain'] ?>
                        <br />
                        <?php echo Yii::t("app", "Length") ?> : <?php echo mb_strlen($website['domain']) ?>
                    </td>
                </tr>
