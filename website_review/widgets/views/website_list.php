...
<ul class="thumbnails" style="text-align:center">
    <?php foreach($data as $website):
        ...
        <li class="span3">
            <div class="thumbnail">
                <h4 align="center"><?php echo Utils::cropDomain($website -> domain). '<br>'; ?></h4>
                <img class="thumbnail rating_ico" id="thumb_<?php echo $website -> id ?>" src="<?php echo Yii::app() -> getBaseUrl(true) ?>/img/loader.gif" alt="<?php echo $website -> domain ?>"	width="205px" height="154px" />
                <br/>
                <p>
